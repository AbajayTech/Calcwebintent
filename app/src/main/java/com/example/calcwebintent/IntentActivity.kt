...
class IntentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Buttonsms.setOnClickListener {
            val uri= Uri.parse("smsto:0778992923")
        ...
        Buttoncall.setOnClickListener {
            val intent = Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "0708952883"))
        ...
        Buttonemail.setOnClickListener {
            ...
            val emailIntent =
                Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "rayabajila@gmail.com", null))
